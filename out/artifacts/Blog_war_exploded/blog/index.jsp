...
<div id="body-wrap">
    <div class="full_page" id="nav" style="background-image: url(https://s1.ax1x.com/2020/05/08/YurCQ0.jpg)">
        <div id="page-header"><span class="pull_left" id="blog_name"><a class="blog_title" id="site-name"
                                                                        href="blog/index.jsp">行路のblog</a></span><span
    ...
    <script>
        ...
        if (subtitleEffect) {
            var typed = new Typed("#subtitle", {
                strings: '要么读书 要么旅行 灵魂和身体必须有一个在路上,Either reading or traveling, body and soul must have one on the way'.split(","),
                startDelay: 300,
                typeSpeed: 150,
                loop: false,
                backSpeed: 50
            ...
            document.getElementById("subtitle").innerHTML = '要么读书 要么旅行 灵魂和身体必须有一个在路上'
        }
